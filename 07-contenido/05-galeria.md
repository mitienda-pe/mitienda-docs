...
Haz clic en **Subir imagen** y selecciona el archivo desde tu computadora.
...
Desde la galería puedes copiar la URL directa de cualquier imagen para pegarla en el editor de páginas, blog u otras secciones.

## Eliminar imágenes

Puedes eliminar imágenes que ya no necesitas. Ten cuidado: si la imagen está siendo usada en alguna página o post, dejará de mostrarse.
